...
[Install the `datajoint-file-validator` package](installation.md). Optionally, [set up a development environment](contribute.md#set-up-a-development-environment.md).
