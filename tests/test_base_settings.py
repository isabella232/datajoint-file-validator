...
def test_annotations_cast(example_settings_cls):
    settings = example_settings_cls(none_val=None, none_val2=None, none_val3=None, my_flag='true', my_path='my/path/')
...
def test_populate_from_dict(example_settings_cls, values_dict):
    settings = example_settings_cls(none_val=None, none_val2=None, none_val3='foobar', my_flag='0', my_path='my/path')
...
def test_populate_from_env_vars(example_settings_cls, values_dict, monkeypatch):
    settings = example_settings_cls(none_val=None, none_val2=None, my_flag='0', my_path='my/path')
